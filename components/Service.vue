...
const block = ref([
  ...
  {id: 5, component: HealthIconVue, name: 'Проведение бизнес тренингов', classBlock: 'w-[381px] h-[284px] rounded-[10px] mr-[21%] border border-mainG bg-[#242424] group flex flex-col justify-center items-center relative'}
])
</script>
