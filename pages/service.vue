...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Мы предлагаем полный пакет услуг, начиная с создания сайта в Худжанд и заканчивая ведением веб-ресурса. Для нас важен долгосрочный результат и постоянный рост.'
    },
    {
      name: 'keywords',
      content: 'fingroup, FinGroup, фингруп, Фин груп, создание сайтов в Таджикистане, создание сайтов в Худжанде, создание и продвижение сайтов, автоматизация бизнес-процессов в Таджикистане, автоматизация бизнес-процессов в Худжанде, качественный проекты, продающий сайт, оптимизация проекта, seo оптимизация'
    }
  ]
})
</script>
...
<template>
  <div class="container mx-auto 2xl:px-[70px] relative px-[20px]">
    <div class="absolute top-[365px] -left-[400px] star" />

    <Service />

    <div class="relative">
      <Industries />
      <img src="../assets/back_img/tn-atom.webp" width="580px" height="580px" class="absolute atom -top-10 -right-64"
        alt="">
